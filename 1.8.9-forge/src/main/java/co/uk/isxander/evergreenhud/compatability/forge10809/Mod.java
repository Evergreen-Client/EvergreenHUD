...
@net.minecraftforge.fml.common.Mod(modid = EvergreenHUD.MOD_ID, name = EvergreenHUD.MOD_NAME, version = EvergreenHUD.MOD_VERSION, clientSideOnly = true)
public class Mod {
            ...
            public UPlayer player() {
                return new UPlayer() {
                    ...
                    public double calculateReachDistFromEntity(UEntity entity) {
                        // TODO: 03/05/2021 legacy reach dist with UEntity
                        return 0;
                    }
                    ...
                    @Override
                    public int id() {
                        return mc.thePlayer.getEntityId();
                    }
                };
            }
